<template>
  <span>
     <svg
      :class="{'is-active':isActive,'is-rotate':rotate}"
      t="1492500959545"
      class="arrow theme-color"
      style=""
...
export default {
  name: 'Arrow',
  props: ["isActive","index","rotate"],
  methods:{
      changeStatus(){
         this.$emit("arrowAction",this.index);
      }
  }
}
</script>
